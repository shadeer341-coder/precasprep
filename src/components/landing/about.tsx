      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <Card className="relative group flex flex-col overflow-hidden transition-all duration-300 hover:scale-[1.02] lg:col-span-2">
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-primary to-accent rounded-lg blur-xl opacity-0 transition duration-500 group-hover:opacity-100 group-hover:blur-3xl"></div>
            <div className="relative bg-card rounded-lg h-full flex flex-col">
              <div className="flex-grow aspect-video overflow-hidden bg-muted/50 p-4 flex flex-col justify-center relative rounded-t-lg">
                <Carousel
                  ...
                  <CarouselContent className="h-[260px]">
                    {allIntegrations.map((integration) => (
                      <CarouselItem key={integration.id} className="basis-1/4">
                        <div className="p-1">
                          <div className={`flex items-center justify-between rounded-lg bg-card p-3 transition-all duration-300`}>
                            ...
                            <div className={`p-2 rounded-full bg-muted transition-all duration-500`}>
